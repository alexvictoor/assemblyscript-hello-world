...
var _debug = require("../build/debug");
const init = async ()=>{
    const { add , hello  } = await _debug.instantiate(await WebAssembly.compileStreaming(globalThis.fetch("debug.wasm")), {
        env: {}
    });
...
},{"../build/debug":"8cG4t"}],"8cG4t":[function(require,module,exports) {
...
//# sourceMappingURL=index.ts.b71e74eb.js.map
